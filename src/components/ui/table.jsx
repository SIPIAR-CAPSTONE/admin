...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors dark:border-b-neutral-700 hover:bg-neutral-100/50 data-[state=selected]:bg-neutral-100  dark:hover:bg-neutral-700 dark:data-[state=selected]:bg-neutral-700",
      className
    )}
    {...props}
  />
