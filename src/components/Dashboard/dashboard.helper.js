export function organizeAnalyticsData(
  ...
  const organizedData = {
    ...
    total_users: topSummary[1].value,
    total_users_increase_this_month: topSummary[1].increase,
    verified_users: topSummary[2].value,
    verified_users_increase_this_month: topSummary[2].increase,
