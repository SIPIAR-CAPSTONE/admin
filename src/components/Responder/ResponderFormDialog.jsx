...
export default function ResponderFormDialog({
  open,
  setOpen,
  defaultValues,
  title,
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <DialogFooter>
              <Button
                disabled={loading}
                className="bg-green-500 hover:bg-green-600 cursor-pointer dark:text-white dark:bg-green-600 dark:hover:bg-green-500"
                type="submit"
              >
                Save changes
              </Button>
